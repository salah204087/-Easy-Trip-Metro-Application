...
class linestation2 extends StatefulWidget {
  const linestation2({Key? key}) : super(key: key);

  @override
  State<linestation2> createState() => _linestation2state();
}

class _linestation2state extends State<linestation2> with TickerProviderStateMixin {
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage(line2[index].img),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
          ...
          child: Column(
            ...
            children: [
              ...
              FadeInUp(
                ...
                from: 40,
                child: Text(line2[index].title, style: textTheme.headline1),
              ),
                  ...
                  child: Row(
                    children: [
                      RatingBar.builder(
                        ...
                        onRatingUpdate: (_) {},
                        initialRating: line2[index].star,
                        minRating: 0,
              ...
              FadeInUp(
                ...
                delay: const Duration(milliseconds: 400),
                from: 40,
                child: Text(line2[index].subTitle,
                    maxLines: 7,
