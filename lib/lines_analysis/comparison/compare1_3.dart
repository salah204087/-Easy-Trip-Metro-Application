...
class compare1_3 extends StatefulWidget {
  final String from;
  final String to;
  final int totaldays;
  compare1_3({Key? key, required this.from, required this.to, required this.totaldays}) : super(key: key);

  @override
  _compare1_3 createState() => _compare1_3();
}

class _compare1_3 extends State<compare1_3> {
      ...
      home: DefaultTabController(
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            title: const Text('Comparison between Line 1 and Line 3'),
          ),
          body: TabBarView(
            children: [
              Padding(
