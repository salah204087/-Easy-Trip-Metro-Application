...
class compare1_2 extends StatefulWidget {
  final String from;
  final String to;
  final int totaldays;
  compare1_2({Key? key, required this.from, required this.to, required this.totaldays}) : super(key: key);

  @override
  _compare1_2 createState() => _compare1_2();
}

class _compare1_2 extends State<compare1_2> {
      ...
      home: DefaultTabController(
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            title: const Text('Comparison between Line 1 and Line 2'),
          ),
          body: TabBarView(
            children: [
              Padding(
